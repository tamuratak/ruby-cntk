...
class Learner
  ...
  def self.training_parameter_schedule(schedule, unit, epoch_size = nil)
  ...
  def self.momentum_schedule(schedule, unit = :minibatch, epoch_size = nil)
    training_parameter_schedule(schedule, unit, epoch_size)
  end

  def self.momentum_as_time_constant_schedule(schedule, epoch_size)
  ...
  def self.sgd_learner(parameters, lr, l1_weight: 0.0, l2_weight: 0.0, 
  ...
  def self.momentum_sgd_learner(parameters, lr, momentum, unit_gain: CNTK.default_unit_gain_value(),
